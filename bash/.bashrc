...
$HOME/repos/dynamic-colors/bin/dynamic-colors switch solarized-light-desaturated

export PATH="$HOME/repos/dynamic-colors/bin:$PATH"
source "$HOME/repos/dynamic-colors/completions/dynamic-colors.bash"
